  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur-xl bg-[#09090b]/80 border-b border-white/[0.06]">
      <div className="max-w-[1120px] mx-auto px-5 py-5 flex justify-between items-center">
        <Link
          to="/"
          className="flex items-center gap-2.5 font-['Outfit'] font-black text-[1.6rem] tracking-tight bg-gradient-to-br from-[#facc15] to-[#f472b6] bg-clip-text text-transparent"
        >
          <img src="/favicon-192.png" alt="DFB?" className="w-8 h-8 rounded-lg" />
          DaFuqBro
          <span className="text-[#71717a] font-medium text-[0.85rem] ml-[-0.35rem] tracking-wide bg-none [-webkit-text-fill-color:#71717a]">
            .com
          </span>
        </Link>
